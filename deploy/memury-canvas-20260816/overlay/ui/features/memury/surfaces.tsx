...
import {canvasPreferredLocale, localeCopy} from './locale'
    ...
    >
      <div className="memury-context-toolbar">
        <div className="memury-context-toolbar__copy">
          <p className="memury-eyebrow">Memury · Canvas</p>
          <h1>{copy('学习助手', 'Learning assistant')}</h1>
          <p className="memury-context-toolbar__summary">
            {copy('在当前任务旁查看依据、风险和下一步。', 'See evidence, risks, and the next step beside your current work.')}
          </p>
        </div>
      </div>
